    ...
    <el-form ref="loginFormRef" :model="loginFormData" :rules="loginRules" size="large"
      ...
      <el-form-item prop="captchaCode">
        <div flex items-center gap-10px>
          <el-input v-model.trim="loginFormData.captchaCode" :placeholder="t('login.captchaCode')" clearable
            class="flex-1" @keyup.enter="handleLoginSubmit">
            <template #prefix>
          ...
          <div cursor-pointer h-40px w-120px flex-center @click="getCaptcha">
            ...
            <img v-else-if="captchaBase64" border-rd-4px object-cover shadow="[0_0_0_1px_var(--el-border-color)_inset]"
              :src="captchaBase64" alt="captchaCode" />
